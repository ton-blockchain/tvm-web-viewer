...
export const ToncenterKeysModal: React.FC<ToncenterKeysModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent rounded="0">
        <ModalHeader fontFamily="IntelOneMono Bold">Settings</ModalHeader>
        <ModalCloseButton />
        <ModalBody pb={6}>
          <VStack spacing={4} align="stretch">
            <Text fontSize="sm">
              Enter Toncenter API keys. Get them {' '}
              <Link href="https://t.me/toncenter" isExternal color="blue.500">
                here
              </Link>
            </Text>
            ...
            <FormControl>
              ...
              <Input
                ...
                onChange={(e) => setTempKeys({ ...tempKeys, mainnet: e.target.value })}
            ...
            <FormControl>
              ...
              <Input
                ...
                onChange={(e) => setTempKeys({ ...tempKeys, testnet: e.target.value })}
            ...
            <Button onClick={handleSave} colorScheme="blue" size="sm" rounded="0">
              Save
            </Button>
          </VStack>
        </ModalBody>
